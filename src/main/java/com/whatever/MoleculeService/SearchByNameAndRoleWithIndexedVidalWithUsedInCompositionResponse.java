...
@XmlRootElement(name = "searchByNameAndRoleWithIndexedVidalWithUsedInCompositionResponse")
public class SearchByNameAndRoleWithIndexedVidalWithUsedInCompositionResponse {
