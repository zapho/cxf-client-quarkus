...
public interface DrugPrescriptionAnalysisService {
    ...
    @RequestWrapper(localName = "commentsToJson", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.CommentsToJson")
    @ResponseWrapper(localName = "commentsToJsonResponse", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.CommentsToJsonResponse")
    ...
    @RequestWrapper(localName = "dosageFromObjToJson", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.DosageFromObjToJson")
    @ResponseWrapper(localName = "dosageFromObjToJsonResponse", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.DosageFromObjToJsonResponse")
     ...
     * @return
     *     returns com.vidal.DrugPrescriptionAnalysisService.PrescriptionAnalysisFull
     */
    @WebMethod
    @WebResult(name = "getAlertsFullWithComments", targetNamespace = "urn:Vidal")
    @RequestWrapper(localName = "getAlertsFullWithComments", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetAlertsFullWithComments")
    @ResponseWrapper(localName = "getAlertsFullWithCommentsResponse", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetAlertsFullWithCommentsResponse")
     ...
     * @param patient
     * @return
     *     returns com.vidal.DrugPrescriptionAnalysisService.PrescriptionAnalysis
     */
    @WebMethod
    @WebResult(name = "getAlertsWithAlertTypes", targetNamespace = "urn:Vidal")
    @RequestWrapper(localName = "getAlertsWithAlertTypes", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetAlertsWithAlertTypes")
    @ResponseWrapper(localName = "getAlertsWithAlertTypesResponse", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetAlertsWithAlertTypesResponse")
     ...
     * 
     * @return
     *     returns com.vidal.DrugPrescriptionAnalysisService.ArrayOfAlert
     */
    @WebMethod
    @WebResult(name = "getAllSadmAlerts", targetNamespace = "urn:Vidal")
    @RequestWrapper(localName = "getAllSadmAlerts", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetAllSadmAlerts")
    @ResponseWrapper(localName = "getAllSadmAlertsResponse", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetAllSadmAlertsResponse")
     ...
     * @return
     *     returns com.vidal.DrugPrescriptionAnalysisService.PrescriptionCostAnalysis
     */
    @WebMethod
    @WebResult(name = "prescriptionCostAnalysis", targetNamespace = "urn:Vidal")
    @RequestWrapper(localName = "getPrescriptionCostAnalysis", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetPrescriptionCostAnalysis")
    @ResponseWrapper(localName = "getPrescriptionCostAnalysisResponse", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.GetPrescriptionCostAnalysisResponse")
    ...
    @RequestWrapper(localName = "patientFromObjToJson2018", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.PatientFromObjToJson2018")
    @ResponseWrapper(localName = "patientFromObjToJson2018Response", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.PatientFromObjToJson2018Response")
    ...
    @RequestWrapper(localName = "prescriptionLineFromObjToJson2018", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.PrescriptionLineFromObjToJson2018")
    @ResponseWrapper(localName = "prescriptionLineFromObjToJson2018Response", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.PrescriptionLineFromObjToJson2018Response")
     ...
     * @param patient
     * @return
     *     returns com.vidal.DrugPrescriptionAnalysisService.ArrayOfCodedReco
     */
    @WebMethod
    @WebResult(name = "recos", targetNamespace = "urn:Vidal")
    @RequestWrapper(localName = "searchRecosByPrescriptions", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.SearchRecosByPrescriptions")
    @ResponseWrapper(localName = "searchRecosByPrescriptionsResponse", targetNamespace = "urn:Vidal", className = "com.vidal.DrugPrescriptionAnalysisService.SearchRecosByPrescriptionsResponse")
