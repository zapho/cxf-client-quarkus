 ...
 *         &lt;element name="comments" type="{urn:Vidal}ArrayOfString"/>
...
@XmlRootElement(name = "getAlertsFullWithComments")
public class GetAlertsFullWithComments {
    ...
    @XmlElement(required = true, nillable = true)
    protected ArrayOfString comments;
    @XmlElement(required = true, nillable = true)
     ...
     *     
     */
    public ArrayOfString getComments() {
        return comments;
    }
     ...
     *     
     */
    public void setComments(ArrayOfString value) {
        this.comments = value;
    }
