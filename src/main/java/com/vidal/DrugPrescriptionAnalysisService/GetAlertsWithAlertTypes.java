 ...
 *         &lt;element name="types" type="{urn:Vidal}ArrayOfAlertType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getAlertsWithAlertTypes")
public class GetAlertsWithAlertTypes {
    ...
    @XmlElement(required = true, nillable = true)
    protected ArrayOfAlertType types;
     ...
     *     
     */
    public ArrayOfAlertType getTypes() {
        return types;
    }
     ...
     *     
     */
    public void setTypes(ArrayOfAlertType value) {
        this.types = value;
    }
